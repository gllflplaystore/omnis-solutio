...
export const badgeVariants = tv({
  slots: {
    root: "inline-flex items-center justify-center rounded-[10px] leading-none transition duration-200 ease-out",
    icon: "shrink-0",
    dot: [
      // base
      "dot",
  ...
  variants: {
    size: {
      small: {
        root: "h-4 gap-2 px-2 text-subheading-2xs uppercase has-[>.dot]:gap-2",
        icon: "-mx-1 size-3",
        dot: "-mx-2 size-4",
      },
      medium: {
        root: "h-5 gap-2 px-2 text-label-sm",
        icon: "-mx-1 size-4",
        dot: "-mx-1.5 size-4",
      },
    },
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      color: "orange",
      class: {
        root: "bg-warning-light text-primary-base",
      },
    },
    {
      variant: "light",
