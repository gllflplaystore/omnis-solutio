...
import MCCoverage from "../sections/MCCoverage";
import MCPaymentInt from "../sections/MCPaymentInt";
// import Faq03 from "@/components/sections/FaqSection";
import Faq03 from "@/countries/ae/sections/FaqSection";
import MCFlexibleAPIs from "../sections/MCFlexibleAPIs";
import greenImage from "@/assets/greenImage.svg";
import MCTrust from "../sections/MCTrust";
import DAUseCase from "../sections/DAUseCase";
import DAFeatureSections from "../sections/DAFeatureSections";
...
export default function UAEMultiCurrencyPage() {
  ...
  return (
    <div className={clsx("w-full", isRTL && "text-right")}>
      <ProductShowcase
        ...
        tag={t("domesticMain.tag")}
        headline={t("domesticMain.headline")}
        description={t("domesticMain.description")}
        features={[]}
        ctaHref={contactHref}
        ctaLabel={t("domesticMain.cta")}
      />
      ...
      <MCFlexibleAPIs />
      <MCTrust />
      <img src={greenImage} className="my-12" />
      <Faq03 />
