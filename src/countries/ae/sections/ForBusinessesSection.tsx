...
import whiteLabel2 from "@/assets/whitelabel2.svg";
import * as Badge from "@/components/ui/Badge";
import DividerComp from "@/components/DividerComp";
import arabicWoman from "@/assets/arabicwoman.svg";
import multiIcons from "@/assets/multiIcons.svg";
...
export default function ForBusinessesSection() {
  ...
  return (
    <>
      <section
        id="for-businesses"
        className="w-full mt-20 px-4 sm:px-6 lg:px-8"
      >
      ...
      {country === "ae" && (
        <ProductShowcase
          id="services"
          imagePosition="left"
          image={<img src={arabicWoman} alt="Domestic Services" />}
      ...
      <ProductShowcase
        id="multi-currency"
        imagePosition="right"
        image={<img src={multiIcons} alt="Multi Currency" />}
        tagIcon={<BarChart2 size={13} />}
        ...
        features={[
          ...
          {
            icon: <Zap size={16} className="text-(--color-primary-base)" />,
            iconColor: "text-(--color-primary-base)",
      ...
      <ProductShowcase
        id="white-label"
        imagePosition="left"
        image={<img src={whiteLabel2} alt="White Label" />}
        ...
        features={[
          ...
          {
            icon: (
              <Settings size={16} className="text-(--color-primary-base)" />
            ),
            iconColor: "text-(--color-primary-base)",
