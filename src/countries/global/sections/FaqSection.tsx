...
export default function Faq03() {
  ...
  return (
    <>
      <section className="bg-bg-white-0 py-10 md:py-14">
        <Container>
          <div className="mx-auto max-w-5xl flex flex-col items-center text-center gap-5">
            ...
            <h4 className="text-title-h4 lg:text-title-h2 text-stroke-strong-950 font-semibold lg:text-center">
              {t("faq.headline")}
            </h4>
            <p className="text-text-sub-600 text-paragraph-md lg:text-center">
              {t("faq.subheading")}
            </p>
          </div>
          ...
          <div className="flex items-center justify-center flex-col gap-5">
            ...
            <div className="bg-bg-weak-50 mx-auto hidden w-fit gap-1 rounded-[96px] p-1 lg:flex py-4 md:py-8">
              {tabsData.map((tab) => (
                <div
                  key={tab.id}
